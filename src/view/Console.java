...
import base.CardapioRepository;
import base.Cartao;
import base.Cheque;
import base.Cliente;
import base.ClienteRepository;
import base.Entregador;
import base.ItemPedido;
import base.Pedido;
import base.PedidoRepository;
...
public class Console extends ViewBase {
	...
	public Console() {
		...
		entregadorView = new EntregadorView(sc);
		funcionarioView = new FuncionarioView(sc, entregadorView);
	}
